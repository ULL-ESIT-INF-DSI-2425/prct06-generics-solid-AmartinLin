...
const EricClapton: Artista<ColeccionMusical> = new Artista("Eric Clapton", 3000000, [disco, layla]);
// Taylor Swift
...
const TaylorSwift: Artista<ColeccionMusical> = new Artista("Taylor Swift", 88200000, [speakKnow, fearless, lover]);
...
describe("Clase Artista", () => {
  test("Saber los datos del artista", () => {
    expect(EricClapton.discografia).toStrictEqual([disco, layla])
